...
namespace acamcad
{
	...
	class CreateOperate_SphereTSpline : public CreateOperate_Sphere
	{
	public:
		//CreateOperate_Sphere();
		CreateOperate_SphereTSpline(const AMCAX::Coord3& center, double radius, size_t rotation_seg, size_t vertical_seg);
